...
<body>
  ...
  <div class="Registration">
    <h2> REGISTER HERE..</h2>
    <div class="container">
      <form action="savecustomerinfo" method="post">
        ...
        <input type="text" name="cemail" placeholder="Email Address.." required>   
        <br>
        ...
        <input type="text" name="ccpass" placeholder="ConfirmPASSWORd">
        <br>
